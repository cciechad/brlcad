...
#
# RCS: @(#) $Id: tkConfig.sh.in 29251 2007-11-06 21:38:54Z erikgreenwald $
...
# build directory.
TK_BUILD_LIB_SPEC='-L/Users/cyapp/release-prep/brlcad/src/other/tk/unix -ltk8.5'

# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/usr/brlcad/lib -ltk8.5'

# String to pass to the compiler so that an extension can
# find installed Tk headers.
TK_INCLUDE_SPEC='-I/usr/brlcad/include'
...
# compiled.
TK_SRC_DIR='/Users/cyapp/release-prep/brlcad/src/other/tk'
...
# build directory.
TK_BUILD_STUB_LIB_SPEC='-L/Users/cyapp/release-prep/brlcad/src/other/tk/unix -ltkstub8.5'

# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/usr/brlcad/lib -ltkstub8.5'

# Path to the Tk stub library in the build directory.
TK_BUILD_STUB_LIB_PATH='/Users/cyapp/release-prep/brlcad/src/other/tk/unix/libtkstub8.5.a'

# Path to the Tk stub library in the install directory.
TK_STUB_LIB_PATH='/usr/brlcad/lib/libtkstub8.5.a'
