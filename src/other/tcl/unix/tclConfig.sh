...
#
# RCS: @(#) $Id: tclConfig.sh.in 29250 2007-11-06 21:35:32Z erikgreenwald $
...
# build directory.
TCL_BUILD_LIB_SPEC='-L/Users/cyapp/release-prep/brlcad/src/other/tcl/unix -ltcl8.5'

# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/usr/brlcad/lib -ltcl8.5'
...
# compiled.
TCL_SRC_DIR='/Users/cyapp/release-prep/brlcad/src/other/tcl'
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/Users/cyapp/release-prep/brlcad/src/other/tcl/unix -ltclstub8.5'

# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/usr/brlcad/lib -ltclstub8.5'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/Users/cyapp/release-prep/brlcad/src/other/tcl/unix/libtclstub8.5.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/usr/brlcad/lib/libtclstub8.5.a'
